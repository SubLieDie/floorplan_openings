...
ℹ **Что произойдёт, если ничего не найдено?**

  - Изображение останется без изменений (ничего не будет отрисовано)
  - Сводка покажет: <code>✅ Найдено: 0 окон, 0 дверей</code>
  - В таблице появится надпись: <code>&lt;p&gt;Не обнаружено элементов&lt;/p&gt;</code>
...
1. **Запустите приложение через Docker** (см. раздел [Установка](#%EF%B8%8F-%D1%83%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%BA%D0%B0)).
2. **Загрузка планов:**
